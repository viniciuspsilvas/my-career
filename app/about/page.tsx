    ...
    <section className="bg-white dark:bg-gray-900 min-h-screen p-8">
      ...
      <div className="max-w-6xl mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">PERSONAL INFOS</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            {stats.map((stat, index) => (
              ...
              >
                <h3 className="text-primary-500 text-3xl font-bold">{stat.value}</h3>
              ...
              <div key={index} className="text-center">
                <div className="w-24 h-24 mx-auto mb-4">
                  <CircularProgressbar
                    ...
                    styles={{
                      path: { stroke: `#3B82F6` }, // Cor primária
                      text: { fill: "#1E293B", fontSize: "24px", fontWeight: "bold" }, // Cor do texto
                    }}
                  />
                </div>
