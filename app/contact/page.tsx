    ...
    <section className="bg-gray-900 text-white min-h-screen p-8">
      ...
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-white font-semibold">contact@vinitech.dev</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-white font-semibold">+55 (11) 98765-4321</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center space-x-6 mb-12">
          <a href="#" className="text-gray-400 hover:text-primary-500 transition-all duration-300">
        ...
        <form className="bg-gray-800 p-8 rounded-lg shadow-lg">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full bg-gray-700 text-white rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          <div className="mt-6">
            ...
            <textarea
              id="message"
              className="w-full bg-gray-700 text-white rounded-md p-3 h-32 focus:outline-none focus:ring-2 focus:ring-primary-500"
